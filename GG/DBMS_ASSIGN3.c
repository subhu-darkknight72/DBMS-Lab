// gcc -o s DBMS_ASSIGN3.c -Imysql -Lmysql/8.0.32/lib `mysql_config --libs`
...
int main(int argc, char *argv[]){
    ...
    if(mysql_real_connect(connection,"localhost","root","","gg",0,NULL,0)==NULL){
        fprintf(stderr,"%s\n",mysql_error(connection));
